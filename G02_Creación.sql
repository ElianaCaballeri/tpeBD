...
ALTER TABLE GR02_COMENTARIO ADD CONSTRAINT COMENTARIO_COMENTA
...
ALTER TABLE GR02_CATEGORIA ADD CONSTRAINT FK_CATEGORIA_NIVEL
...
ALTER TABLE GR02_COMENTA ADD CONSTRAINT FK_COMENTA_JUEGO
...
ALTER TABLE GR02_COMENTA ADD CONSTRAINT FK_COMENTA_USUARIO
...
ALTER TABLE GR02_JUEGA ADD CONSTRAINT FK_JUEGA_JUEGO
    FOREIGN KEY (id_juego)
    REFERENCES GR02_JUEGO (id_juego)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
...
ALTER TABLE GR02_JUEGA ADD CONSTRAINT FK_JUEGA_USUARIO
    FOREIGN KEY (id_usuario)
    REFERENCES GR02_USUARIO (id_usuario)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
...
ALTER TABLE GR02_JUEGO ADD CONSTRAINT FK_JUEGO_CATEGORIA
...
ALTER TABLE GR02_RECOMENDACION ADD CONSTRAINT FK_RECOMENDACION_JUEGA
    FOREIGN KEY (id_usuario, id_juego)
...
ALTER TABLE GR02_USUARIO ADD CONSTRAINT FK_USUARIO_NIVEL_USUARIO
...
ALTER TABLE GR02_VOTO ADD CONSTRAINT FK_VOTO_JUEGA
    FOREIGN KEY (id_usuario, id_juego)
    REFERENCES GR02_JUEGA (id_usuario, id_juego)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
